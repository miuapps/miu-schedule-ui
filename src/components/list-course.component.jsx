                  ...
                  <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                      ...
                      <p className="mt-2 text-sm text-gray-700">
                        A list of all the courses in the university calendar.
                      </p>
                    </div>
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                            {
                              this.state.courses.map((course) => (
                                <tr key={course.id}>
                                  ...
                                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Faculty</td>
                                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{course.capacity}</td>
                                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{course.block.name}</td>
